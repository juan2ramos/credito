...
<div id="contenedor" style=" margin:auto;width:800px;">
    ...
    <div id="imagen1" style="height:385px;text-align:center;">
        <a href="{{asset('sign-up')}}">
            <img  src="http://creditos.lilipink.com/img/denegado.jpg" width="800" alt="creditoslilipink">
        </a>
    </div>
    <div id="textocre" style="color: #999;
            ...
            font-family:Arial, Helvetica, sans-serif;
            padding-bottom: 10px;">
        Lilipink le informa que su solicitud de credito fue rechazada. dale <a href="{{asset('sign-up')}}">aqui</a> para iniciar session </div>
