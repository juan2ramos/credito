...
class ExtractsController extends \BaseController {
	...
	/*public function prueba(){
		$user = User::whereRaw("roles_id = 4 and identification_card = 1031146949")->first();
		$extracts = Extract::whereRaw("nit = 1031146949")->orderBy('id', 'DESC')->get();
		$minPay = ExcelDaily::whereRaw("cedula = 1031146949")->get();
		//$quota = CreditRequest::where('user_id', $user->id)->first();
		...
		return View::make('pdf.extractoprueba', compact('user', 'day', 'extracts', 'minPay', 'months', 'quota'));
	} */
}
