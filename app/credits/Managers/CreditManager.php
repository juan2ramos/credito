...
class CreditManager extends BaseManager
{
    ...
    public function getRules()
    {
        $rules=[
            ...
            'phone_reference'       => 'required|numeric|digits_between:10,10',
            'name_reference2'       => 'required',
            'phone_reference2'      => 'required|numeric|digits_between:10,10',
            'files'                 => 'required',
            ...
            'mobile_phone'          => 'numeric|required_if:phone,null|digits_between:10,10',
            'phone'                 => 'numeric|required_if:mobile_phone,null|digits_between:7,7',
    ...
    public function getMessage()
    {
        $messages = [
            ...
            'mobile_phone.digits_between'   => 'El campo debe tener 10 digitos',
            'phone.digits_between'   => 'El campo debe tener 7 digitos',
            'phone_reference.digits_between'   => 'El campo debe tener 10 digitos',
            'phone_reference2.digits_between'   => 'El campo debe tener 10 digitos',
